...
const Header = () => {
  ...
  const [activeLink, setActiveLink] = useState<string>("nav_modern")
  const [isOpen, setIsOpen] = useState(false)

  const toggleNavbar = () => setIsOpen(!isOpen)
  
  const links = ["nav_modern", "nav_discussion", "nav_visual", "nav_development", "nav_presentation", "nav_support"]
