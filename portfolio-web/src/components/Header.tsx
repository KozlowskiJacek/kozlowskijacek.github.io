...
const Header = () => {
  ...
  return (
    <header className={`bg-bg_color_1 text-white top-0 left-0 w-full p-5 px-2 flex z-100 fixed ${isScrolled ? 'border-b-[0.1rem] border-b-[rgba(0,0,0,0.2)]' : ''}`}>
      <div className="container mx-auto flex justify-between items-center">
        <a href="#" className='text-2xl text-white font-semibold cursor-default'> Jacek Kozłowski</a>
        
        
        <div className="flex space-x-11 text-white text-base ">
