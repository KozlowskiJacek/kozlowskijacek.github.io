  ...
  return (
    ...
    <section className='bg-bg_color_2 flex justify-center items-center min-h-screen w-full pt-[100px] px-[9%] pv-[20px]'>
      ...
      <motion.div className="w-full text-white"
          ...
          viewport={{ once: false, amount: 0.5 }}
        >
          <h3 className='text-4xl font-bold mb-4'>{t("web_app.project")} <span className='text-main_accent'>{t("web_app.concept")}</span></h3>
    ...
    <section className='bg-bg_color_2 flex justify-center items-center min-h-screen w-full pt-[100px] px-[9%] pv-[20px]'>
      ...
      <motion.div className='text-white w-full'
        ...
        viewport={{ once: false, amount: 0.5 }}
      >
        <h3 className='text-4xl font-bold mb-4'>{t("web_app.coding")} <span className='text-main_accent'>{t("web_app.implementation")}</span></h3>
      ...
      <motion.div className="w-full text-white"
          ...
          viewport={{ once: false, amount: 0.5 }}
        >
          <h3 className='text-4xl font-bold mb-4'>{t("web_app.presentation")} <span className='text-main_accent'>{t("web_app.ready")}</span></h3>
    ...
    <section className='bg-bg_color_2 flex justify-center items-center min-h-screen w-full pt-[100px] px-[9%] pv-[20px]'>
      ...
      <motion.div className='text-white w-full'
        ...
        viewport={{ once: false, amount: 0.5 }}
      >
        <h3 className='text-4xl font-bold mb-4'>{t("web_app.support")} <span className='text-main_accent'>{t("web_app.after")}</span></h3>
