  ...
  return (
    <section className='text-white bg-bg_color_1 flex flex-col justify-center items-center min-h-screen w-full pt-[100px] px-[9%] pv-[20px]' id='services'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        <div className='bg-bg_color_2 w-[350px] h-[500px] md:w-[480px] md:h-[400px] -mx-4 md:mx-auto mb-5 p-6 pb-8 rounded-2xl text-center border-2 border-bg_color_1 transition duration-500 ease hover:border-main_accent hover:scale-105'>
        ...
        <div className='bg-bg_color_2 w-[350px] h-[500px] md:w-[480px] md:h-[400px]  md:mx-auto mb-10 p-6 pb-8 rounded-2xl text-center border-2 border-bg_color_1 transition duration-500 ease hover:border-main_accent hover:scale-105'>
